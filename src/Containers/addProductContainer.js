...
class AddProductContainer extends React.Component {
        ...
        return ( 
            ...
            <form>
                ...
                <label> Name </label>
                <input type='text' id="productName" placeholder="Enter Name" onChange={this.getName} ></input>
               
                <br></br>
                <br></br>
                <label>price</label>
                <input type='number' id="productPrice" placeholder="Enter Price" onChange={this.getprice} />
               
                 <br></br>
                 <br></br>
                 <label>Description</label>
                <input type='text' id="productDescription" placeholder="Enter Description" onChange={this.getDescription} ></input>
               
                 <br></br>
                 <br></br>
                 <label>Stock</label>
                <input type='number' id="productStock" placeholder="Enter Stock" onChange={this.getStock} ></input>
                ...
                <select name='category' id="productCategory" onChange={this.getCategory} >
                 ...
                 <label> &nbsp;Product Image: </label>
                    <input type="text" placeholder="Enter Image Url" onChange={this.getImage} />
                    <br></br>
                    <br></br>
